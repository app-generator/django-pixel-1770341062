...
- Get [Support](https://app-generator.dev/ticket/create/?generated_repo=https://github.com/app-generator/django-pixel-1770341062) via `eMail` and `Discord`
- Resources:
...
```bash
$ git clone https://github.com/django-pixel-1770341062.git
$ cd django-pixel-1770341062
```
